...
def create_enemy():
    ...
    enemy_rect = pygame.Rect(WIDTH, random.randint(10, HEIGHT - enemy_size[1] - 10), *enemy_size)
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(10, WIDTH - bonus_size[0] - 10), 10, *bonus_size)
...
while playing:
    ...
    main_display.blit(FONT.render(str(score), True, COLOR_GOLD), (WIDTH-50, 20))
